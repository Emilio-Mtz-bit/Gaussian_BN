...
data_clean <- data %>%
  select(
    ...
    valor_COL_LDL, valor_COLEST, valor_CREAT, valor_ALBU, CO, PM_010, COV
  ) %>%
  rename(
    NO2 = NOx,
    PM25 = PM_2_5,
...
```{r}
dag = empty.graph(nodes = c("Hemoglobina", "AcidoUrico", "Albumina", "ColesterolHDL", "ColesterolLDL", "ColesterolTotal", "Creatinina", "Glucosa", "Insulina", "PCR", "Trigliceridos", "HbA1c", "Edad", "SO2", "CO", "NO2", "PM10", "PM25", "COV"))
