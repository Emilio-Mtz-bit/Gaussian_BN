...
```{r}
dag3_nodes <- c("PM25", "NO2", "SO2", "NH3", "Edad", "PCR", "AcidoUrico", "Glucosa", "Insulina", "HbA1c", "EAG", "Trigliceridos", "ColesterolHDL", "ColesterolLDL", "ColesterolTotal", "Creatinina", "Albumina", "Hemoglobina", "Ferritina", "VitaminaD", "VitaminaB12", "SindromeMetabolico", "ResistenciaInsulina")
```
...
arc_set3 <- matrix(c(
  ...
  "ResistenciaInsulina", "SindromeMetabolico",
  "Trigliceridos", "SindromeMetabolico",
  "ColesterolHDL", "SindromeMetabolico",
  "PCR", "SindromeMetabolico",
  "PCR", "Glucosa",
  "PCR", "Insulina",
  "PCR", "Trigliceridos",
  "PCR", "Ferritina",
...
mod_SindromeMetabolico <- lm(SindromeMetabolico ~ ResistenciaInsulina + Trigliceridos + ColesterolHDL + PCR, data = data_clean)
...
-1/2*(BIC(mod_PCR) + BIC(mod_AcidoUrico) + BIC(mod_Glucosa) + BIC(mod_Insulina) + 
      ...
      BIC(mod_SindromeMetabolico) + BIC(mod_Creatinina) + BIC(mod_Albumina) +
